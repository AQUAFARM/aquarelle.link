<?php
/**
 * Template part for displaying link post.
 *
...
<?php
    ...
    ?>
            ...
            <div class="card-image card-link valign-wrapper" data-bg="<?php echo esc_url( $image_url1 ); ?>">
                <a href="<?php the_permalink();?>" class="fulla"></a>
                <span class="card-title"><i class="fa fa-link"></i></span>
            </div>

        <?php else : ?>
            <!-- If the Post doesnot have any thumbnail -->
            <div class="no-image card-image card-link valign-wrapper">
                <a href="<?php the_permalink();?>" class="card-title"><i class="fa fa-link"></i></a>
            </div>
        <?php endif;?>
        ...
        <?php else : ?>
        <!-- If the Post doesnot have any thumbnail -->
            <div class=" card-image card-link  valign-wrapper center-align">
                <span class="card-title"><i class="fa fa-link"></i></span>
